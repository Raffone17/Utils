...
{
  public static void salva(Contatti c)
  {
    EntityManager em
            = PM.getEM();
  ...
  public static List elenco() { 
      ...
      try { Query q = em.createNamedQuery("Contatti.findAll");
  ...
  } public static void elimina(Contatti c) { 
      EntityManager em = PM.getEM();
      EntityTransaction et = em.getTransaction();
      try {
          et.begin();
          c = em.find(Contatti.class, c.getId());
          em.remove(c);
          et.commit();
      } finally { 
