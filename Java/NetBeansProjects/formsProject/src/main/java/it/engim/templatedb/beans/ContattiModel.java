...
public class ContattiModel extends LoadableDetachableModel<Contatti>{

    private int id;
    
    public ContattiModel(int id)
    {
        this.id= id;
    }
    @Override
    protected Contatti load() 
    {
        ...
        try
        {
            Contatti c = em.find(Contatti.class, id);
             return c;
        }
        finally
        {
